      ...
      <header className="header">
        ...
        <ul className="list-header">
          <li className="item-header">
            ...
            <p>Vous trouverez sur cette page, une sélection de mes projets. Ils ont été ralisé dans le cadre de projets d'école, en freelance ou en agence.</p>
          </li>
          <li className="item-header">
          ...
          <li className="item-header">
            ...
            <p><i className="fa fa-envelope-o" aria-hidden="true"></i><a className="link-header" href="http://www.vincentaguettaz.com/CV_VincentAguettaz.pdf">CV_VincentAguettaz.pdf</a></p>
          </li>
        </ul>
      </header>
    )
